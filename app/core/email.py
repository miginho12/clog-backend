...
def _verification_html(nickname: str, verify_url: str) -> str:
    """인증 메일 HTML 본문 (새 브랜드 컬러 — 보라/코랄. password_reset 메일과 톤 통일)."""
    return f"""\
<!DOCTYPE html>
<html lang="ko">
  ...
  <div style="max-width:480px;margin:40px auto;background:#fff;border-radius:16px;overflow:hidden;">
    ...
    <div style="padding:32px 28px;">
      ...
      <div style="text-align:center;margin:28px 0;">
        <a href="{verify_url}"
           style="display:inline-block;background:linear-gradient(135deg,#7C5CD8,#9B6CE0);color:#fff;
                  text-decoration:none;padding:13px 32px;border-radius:12px;
      ...
      <p style="font-size:12px;color:#C5BDD9;margin-top:20px;">
